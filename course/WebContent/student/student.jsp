...
<div class="main">
	...
	<div class="main_right">
		...
		<div class="box">
			...
			<tr><td>根据学校教学安排，本学期全校任选课定于6月25日（星期五） 正式开课，选课工作将从6月22日开始。现将有关事项通知如下：</td></tr>
			<tr><td>一、选课时间：6月22日----6月25日</td></tr>
			<tr><td>二、学生登录选课信息管理系统后进入学生选课进行选课。学生选课前请认真阅读选课公告，再进行“网上选课”。</td></tr>
			<tr><td>三、教师可登陆选课信息管理系统后进入选课管理增删课程， 6月25日14:00之后各位教师及学生登录教务处网站查询自己申报的课程是否停开。</td> </tr>
			...
			<tr><td align="right">2020-06-22</td></tr>
			</table>
			</div>
		</div>
	</div>
