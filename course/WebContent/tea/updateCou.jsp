		...
		<div class="box">
			...
			<div style="color:red;">${msg }</div>
				...
				<table>
  					...
  					<tr><td></td></tr>
  					<tr><td>课程编号</td> <td><input  class="text" type="text" name="CNo" value="${course.cno}" readonly="true"/></td></tr>
  					<tr><td>课程名称</td> <td><input  class="text" type="text" name="Cname" value="${course.cname}"/></td></tr>
  					<tr><td>课程学分</td> <td><input  class="text" type="text" name="Ccredit" value="${course.ccredit}"/></td></tr>
